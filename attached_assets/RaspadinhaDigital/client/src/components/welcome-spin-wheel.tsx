...
export default function WelcomeSpinWheel({ isOpen, onClose }: WelcomeSpinWheelProps) {
  ...
  const handleSpin = async () => {
    ...
    try {
      ...
      // Show prize popup
      showFreePlayWin(2, "raspadinhas PIX", "Você ganhou 2 raspadinhas PIX grátis!");
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 drop-shadow-md">
              {hasSpun ? "Você já utilizou seu bônus de boas-vindas!" : "Gire a roleta e ganhe raspadinhas grátis!"}
            </p>
          </div>
