...
export function Ajuda() {
  ...
  const helpTopics = [
    ...
    },
    {
      id: "jogos",
      icon: Trophy,
      title: "Como funcionam as raspadinhas?",
      content: [
        "Raspe os 9 quadradinhos da raspadinha, encontre 3 premios iguais para ganhar",
      ],
    },
    {
      id: "bonus",
      ...
      content: [
        "• Ganhe raspadinhas bônus girando a roleta diaria",
        "• Ou ganhe fazendo depositos",
        "• Jogue a raspadinha para virar saldo real",
      ],
    },
    {
      id: "giro-diario",
      ...
      content: [
        "• Ganhe raspadinhas grátis todos os dias",
        "• Quantidade de prêmios aumenta com seu nível:",
        "  - Bronze (2-24): 2-8 raspadinhas",
        "  - Prata (25-49): 5-25 raspadinhas",
        "  - Ouro (50-74): 10-50 raspadinhas",
        "  - Platina (75-99): 25-100 raspadinhas",
        "  - Diamante (100+): 50-200 raspadinhas",
    ...
    },
    {
      ...
      content: [
        ...
        "• Calculado sobre raspadinhas não premiadas",
    ...
    },
    {
      ...
      content: [
        "• Bronze (Nível 2): Resgate 5 raspadinhas",
        "• Prata (Nível 25): Resgate 25 raspadinhas",
        "• Ouro (Nível 50): Resgate 75 raspadinhas",
        "• Platina (Nível 75): Resgate 200 raspadinhas",
        "• Diamante (Nível 100): Resgate 600 raspadinhas",
        "",
        "Cada rank também oferece:",
        "• Maior cashback diário",
        "• Mais raspadinhas no giro diário",
    ...
    },
    {
      ...
      content: [
        ...
        "• Ganhe entre 1 a 10 raspadinhas bônus",
        "• Nova chance disponível a cada 24 horas",
        "• Prêmios creditados automaticamente",
        "• Use as raspadinhas bônus para ganhar saldo real",
