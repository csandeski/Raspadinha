        ...
        <div className="min-h-full bg-gradient-to-b from-[#0E1015] via-[#1a1b23] to-[#0E1015] flex flex-col pt-12">
          <div className="flex-1 flex items-center justify-center px-4">
            <div className="max-w-md w-full text-center">
              ...
              >
                <span>Ir para as raspadinhas</span>
                  ...
                  <div className="relative bg-gradient-to-br from-[#00E880]/30 via-[#00D470]/25 to-[#00E880]/30 rounded-xl p-6 border-2 border-[#00E880]/50 shadow-2xl shadow-[#00E880]/20 backdrop-blur-sm">
                    <div className="text-center">
                      ...
                      >
                        ...
                        <span className="text-xl text-white font-bold">Raspadinhas Bônus!</span>
                      </motion.div>
          ...
          <div>
            ...
            {(customAmount || amount) && currentCoupon?.hasAppliedCoupon && (
              <motion.div
                ...
                className="mt-2"
              >
                <div className="relative overflow-hidden bg-gradient-to-r from-purple-600/15 to-purple-500/15 backdrop-blur-sm rounded-xl p-3 border border-purple-500/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-500 rounded-lg flex items-center justify-center shadow-md">
                        <Gift className="w-4 h-4 text-white" />
                      </div>
                      <div className="flex items-center gap-3">
                        <div>
                          <p className="text-[10px] text-gray-500 leading-none mb-1">GANHE</p>
                          <div className="flex items-baseline gap-1">
                            ...
                            <span className="text-xs text-gray-400">raspadinhas</span>
                          </div>
                        </div>
                        <div className="h-8 w-px bg-purple-500/20 mx-2"></div>
                        <div className="flex flex-col justify-center items-end pr-1">
                          <span className="text-[9px] text-yellow-400 font-bold animate-pulse">DEPOSITE MAIS!</span>
                          <span className="text-[10px] font-semibold text-purple-400 text-right">
                            {(() => {
                              const value = parseFloat(customAmount || amount || "0");
                              if (value >= 300) return "Máximo atingido! 🎯";
                              if (value >= 200) return "+100 com R$300";
                              if (value >= 150) return "+50 com R$200";
                              if (value >= 100) return "+40 com R$150";
                              if (value >= 80) return "+15 com R$100";
                              if (value >= 60) return "+15 com R$80";
                              if (value >= 50) return "+6 com R$60";
                              if (value >= 40) return "+12 com R$50";
                              if (value >= 30) return "+6 com R$40";
                              if (value >= 20) return "+3 com R$30";
                              return "Ganhe bônus!";
                            })()}
                          </span>
                        </div>
                    ...
                    {currentCoupon?.hasAppliedCoupon && (
                      <div className="bg-gradient-to-r from-purple-600 to-purple-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm">
                        BÔNUS
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-2">
                    <div className="w-full bg-black/20 rounded-full h-1">
                      <motion.div 
                        className="bg-gradient-to-r from-purple-600 to-purple-500 h-1 rounded-full"
                        initial={{ width: "0%" }}
                        animate={{ 
                    ...
                    <p className="text-[9px] text-gray-500 mt-0.5 text-center">
                      {(() => {
                        ...
                        const tier = bonusTiers.find(t => value >= t.minAmount);
                        const currentCards = tier ? tier.cards : 0;
                        return value >= 300 
                          ? "Bônus máximo atingido!" 
                          : `${currentCards}/250 raspadinhas`;
                      })()}
                    </p>
                  </div>
                </div>
