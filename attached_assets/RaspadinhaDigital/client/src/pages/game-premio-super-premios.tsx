                            ...
                            <>
                              ...
                              {multiplier > 1 && prize > 0 ? (
                                <motion.div
                                  ...
                                  className="mb-2"
                                >
                                  <p className="text-2xl font-black text-yellow-400 animate-pulse drop-shadow-glow">
                                    R$ {(prize / multiplier).toFixed(2)} x {multiplier} = R$ {prize.toFixed(2)}
                                  </p>
                                </motion.div>
                              ) : (
                                <p className="text-4xl font-black text-green-400 mb-2 drop-shadow-glow">
                                  ...
                                  >
                                    <span className="flex items-center justify-center gap-2 whitespace-nowrap">
                                      <span className="text-white text-sm md:text-base font-black uppercase">
                                        {isLoading ? "..." : gameComplete && resultReady ? "Jogar Novamente" : "Comprar"}
                                      </span>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Clique em "Comprar" ou use o "Bônus" se disponível</p>
                  </div>
                </motion.div>
