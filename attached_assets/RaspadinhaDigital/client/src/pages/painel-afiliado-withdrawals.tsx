...
export function PainelAfiliadoWithdrawals() {
  ...
  const withdrawMutation = useMutation({
    mutationFn: async (data: any) => {
      return apiRequest("/api/affiliate/withdrawals", "POST", data);
    },
    onSuccess: (response, variables) => {
      ...
      setTimeout(() => {
        ...
        setDocument("");
        queryClient.invalidateQueries({ queryKey: ["/api/affiliate/earnings"] });
  ...
  return (
    <AffiliateLayout activeSection="withdrawals">
              ...
              {settingsData?.pixKey ? (
                <div className="bg-gradient-to-r from-[#00E880]/10 to-green-600/10 rounded-xl p-4 border border-[#00E880]/20">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="md:ml-4">
                      <Button
                        onClick={() => setLocation('/afiliados/settings')}
                        variant="ghost"
                        size="sm"
                ...
                <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 rounded-xl p-4 border border-orange-500/20">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="md:ml-4">
                      <Button
                        onClick={() => setLocation('/afiliados/settings?section=pix')}
                        variant="ghost"
                        size="sm"
