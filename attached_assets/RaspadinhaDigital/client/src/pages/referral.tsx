...
export default function ReferralPage() {
  ...
  const handleCopyCode = () => {
    const message = `Cadastre-se na Mania Brasil e ganhe até 250 raspadinhas grátis! Use meu código de convite: ${referralCode} - Acesse: https://mania-brasil.com/register?ref=${referralCode}`;
  ...
  const handleShare = () => {
    const message = `Cadastre-se na Mania Brasil e ganhe até 250 raspadinhas grátis! Use meu código de convite: ${referralCode} - Acesse: https://mania-brasil.com/register?ref=${referralCode}`;
    const title = 'Mania Brasil - Ganhe até 250 raspadinhas grátis!';
