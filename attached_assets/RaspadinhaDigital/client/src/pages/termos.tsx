  ...
  const termsSection = [
    {
      ...
      content: [
        "Ao acessar e usar a plataforma Raspadinha da Sorte, você concorda com estes termos de uso.",
        ...
        <div className="px-4 py-6 md:px-6 md:py-8 max-w-4xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl border border-gray-700 p-4 md:p-6">
            <p className="text-gray-300 text-sm md:text-base leading-relaxed">
              Bem-vindo à Raspadinha da Sorte! Estes termos de uso regulam o acesso e uso de nossa plataforma de jogos online. Por favor, leia com atenção.
            </p>
          </div>
