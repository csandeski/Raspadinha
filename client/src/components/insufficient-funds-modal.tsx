            ...
            <div className="text-center mb-4">
              ...
              <p className="text-gray-400 text-sm">
                {type === "balance" 
                  ...
                  : `Você precisa de ${requiredAmount} Mania Bônus mas tem apenas ${currentAmount}`
                }
              </p>
            </div>
            ...
            <div className={`p-4 rounded-2xl mb-6 ${
              ...
              <p className="text-sm text-gray-300 text-center">
                {type === "balance"
                  ...
                  : "Ganhe Mania Bônus através do sistema de recompensas, subindo de nível ou na roleta diária!"
                }
              </p>
            </div>
