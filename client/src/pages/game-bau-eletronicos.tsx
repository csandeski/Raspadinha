...
export default function GameBauEletronicos() {
  ...
  const prizeData = [
    { value: "100000.00", path: "/premios/eletronicos/100000.webp", name: "Kit Completo Apple" },
    { value: "10000.00", path: "/premios/eletronicos/10000.webp", name: "iPhone 16 Pro" },
    { value: "5000.00", path: "/premios/eletronicos/5000.webp", name: "Notebook Dell G15" },
    { value: "2000.00", path: "/premios/eletronicos/2000.webp", name: "Smart TV 55\" 4K" },
    { value: "1000.00", path: "/premios/eletronicos/1000.webp", name: "Caixa de Som JBL" },
    { value: "500.00", path: "/premios/eletronicos/500.webp", name: "Air Fryer" },
    { value: "200.00", path: "/premios/eletronicos/200.webp", name: "SmartWatch" },
    { value: "100.00", path: "/premios/eletronicos/100.webp", name: "Fone sem Fio" },
    { value: "50.00", path: "/premios/eletronicos/50.webp", name: "Power Bank" },
    { value: "20.00", path: "/premios/eletronicos/20.webp", name: "Capinha de Celular" },
    { value: "15.00", path: "/premios/eletronicos/15.webp", name: "Suporte de Celular" },
    { value: "10.00", path: "/premios/eletronicos/10.webp", name: "Cabo USB" },
    { value: "5.00", path: "/premios/eletronicos/5.webp", name: "5 reais" },
    { value: "4.00", path: "/premios/eletronicos/4.webp", name: "4 reais" },
    { value: "3.00", path: "/premios/eletronicos/3.webp", name: "3 reais" },
    { value: "2.00", path: "/premios/eletronicos/2.webp", name: "2 reais" },
    { value: "1.00", path: "/premios/eletronicos/1.webp", name: "1 real" },
    { value: "0.50", path: "/premios/eletronicos/0.5.webp", name: "50 centavos" }
  ];
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-24 md:pb-8 max-w-md md:max-w-3xl mx-auto w-full">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-2xl md:text-4xl font-bold text-orange-400 mt-[-5px] mb-[-5px]">Baú Eletrônicos</h1>
            <p className="text-gray-400 text-sm md:text-base mt-1">
              Abra, <span className="text-orange-400 font-bold">ganhe</span> na hora!
            </p>
          </div>
        </div>
        {/* ChestGame Component */}
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-orange-600/10 via-purple-600/10 to-orange-600/10 blur-3xl -z-10"></div>
        ...
        {/* Game Feed */}
        <GameFeed gameName="Baú Eletrônicos" gameColor="orange" />
      </div>
