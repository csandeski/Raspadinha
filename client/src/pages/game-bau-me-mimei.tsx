...
export default function GameBauMeMimei() {
  ...
  const prizeData = [
    { value: "100000.00", path: "/premios/me-mimei/100000.webp", name: "Anel Vivara Diamante" },
    { value: "10000.00", path: "/premios/me-mimei/10000.webp", name: "Dyson Secador" },
    { value: "5000.00", path: "/premios/me-mimei/5000.webp", name: "Bolsa Michael Kors" },
    { value: "2000.00", path: "/premios/me-mimei/2000.webp", name: "Kit Kerastase" },
    { value: "1000.00", path: "/premios/me-mimei/1000.webp", name: "Kit Bruna Tavares" },
    { value: "500.00", path: "/premios/me-mimei/500.webp", name: "Perfume Good Girl" },
    { value: "200.00", path: "/premios/me-mimei/200.webp", name: "Kit WEPINK" },
    { value: "100.00", path: "/premios/me-mimei/100.webp", name: "Bolsa Petite Jolie" },
    { value: "50.00", path: "/premios/me-mimei/50.webp", name: "Perfume Egeo Dolce" },
    { value: "20.00", path: "/premios/me-mimei/20.webp", name: "Iluminador Bruna Tavares" },
    { value: "15.00", path: "/premios/me-mimei/15.webp", name: "Máscara Ruby Rose" },
    { value: "10.00", path: "/premios/me-mimei/10.webp", name: "Batom Boca Rosa" },
    { value: "5.00", path: "/premios/me-mimei/5.webp", name: "5 reais" },
    { value: "4.00", path: "/premios/me-mimei/4.webp", name: "4 reais" },
    { value: "3.00", path: "/premios/me-mimei/3.webp", name: "3 reais" },
    { value: "2.00", path: "/premios/me-mimei/2.webp", name: "2 reais" },
    { value: "1.00", path: "/premios/me-mimei/1.webp", name: "1 real" },
    { value: "0.50", path: "/premios/me-mimei/0.5.webp", name: "50 centavos" }
  ];
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-24 md:pb-8 max-w-md md:max-w-3xl mx-auto w-full">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-2xl md:text-4xl font-bold text-pink-400 mt-[-5px] mb-[-5px]">Baú Delas</h1>
            <p className="text-gray-400 text-sm md:text-base mt-1">
              Abra, <span className="text-pink-400 font-bold">ganhe</span> na hora!
            </p>
          </div>
        </div>
        {/* ChestGame Component */}
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-pink-600/10 via-purple-600/10 to-pink-600/10 blur-3xl -z-10"></div>
        ...
        {/* Game Feed */}
        <GameFeed gameName="Baú Delas" gameColor="pink" />
      </div>
