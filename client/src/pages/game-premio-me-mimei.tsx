...
import { ArrowLeft, Heart, Sparkles, Star, Eye, Info, Gift, ShoppingCart, X, ChevronLeft, ChevronRight } from "lucide-react";
...
// Product images now use .webp format with numeric naming

const getRarity = (value: string): string => {
  if (!value || value === "") return "common";
  const num = parseFloat(value);
  if (isNaN(num)) return "common";
  if (num >= 5000) return "mythic";
  if (num >= 50) return "rare";
  return "common";
};
...
const getRarityBadge = (value: string): string | null => {
  ...
  if (num >= 5000) return "MÍTICA";
  if (num >= 50) return "RARA";
  return null;
};
...
const getPrizeInfo = (value: string): { icon: string; name: string; path: string } => {
  ...
  if (!isNaN(prizeValue)) {
    ...
    switch (normalizedValue) {
      case "0.50": return { icon: "💸", name: "50 centavos", path: `/premios/me-mimei/0.5.webp` };
      case "1.00": return { icon: "💸", name: "1 real", path: `/premios/me-mimei/1.webp` };
      case "2.00": return { icon: "💸", name: "2 reais", path: `/premios/me-mimei/2.webp` };
      case "3.00": return { icon: "💸", name: "3 reais", path: `/premios/me-mimei/3.webp` };
      case "4.00": return { icon: "💸", name: "4 reais", path: `/premios/me-mimei/4.webp` };
      case "5.00": return { icon: "💸", name: "5 reais", path: `/premios/me-mimei/5.webp` };
      case "10.00": return { icon: "💋", name: "Batom Boca Rosa", path: `/premios/me-mimei/10.webp` };
      case "15.00": return { icon: "🎨", name: "Máscara Ruby Rose", path: `/premios/me-mimei/15.webp` };
      case "20.00": return { icon: "💦", name: "Iluminador Bruna Tavares", path: `/premios/me-mimei/20.webp` };
      case "50.00": return { icon: "💅", name: "Perfume Egeo Dolce", path: `/premios/me-mimei/50.webp` };
      case "100.00": return { icon: "👜", name: "Bolsa Petite Jolie", path: `/premios/me-mimei/100.webp` };
      case "200.00": return { icon: "🎁", name: "Kit WEPINK", path: `/premios/me-mimei/200.webp` };
      case "500.00": return { icon: "👜", name: "Perfume Good Girl", path: `/premios/me-mimei/500.webp` };
      case "1000.00": return { icon: "🏬", name: "Kit Completo Bruna Tavares", path: `/premios/me-mimei/1000.webp` };
      case "2000.00": return { icon: "📿", name: "Kit Kerastase", path: `/premios/me-mimei/2000.webp` };
      case "5000.00": return { icon: "👜", name: "Bolsa Luxo Michael Kors", path: `/premios/me-mimei/5000.webp` };
      case "10000.00": return { icon: "💨", name: "Dyson Secador", path: `/premios/me-mimei/10000.webp` };
      case "100000.00": return { icon: "💎", name: "Anel Vivara Diamante", path: `/premios/me-mimei/100000.webp` };
      default: return { icon: "💄", name: "Prêmio", path: `/premios/me-mimei/1.webp` };
    }
  }
  
  return { icon: "💄", name: value, path: `/premios/me-mimei/1.webp` };
};
...
export default function GamePremioMeMimei() {
  ...
  useEffect(() => {
    const preloadImages = () => {
      const imagePaths = [
        "/premios/me-mimei/0.5.webp", "/premios/me-mimei/1.webp", "/premios/me-mimei/2.webp",
        "/premios/me-mimei/3.webp", "/premios/me-mimei/4.webp", "/premios/me-mimei/5.webp",
        "/premios/me-mimei/10.webp", "/premios/me-mimei/15.webp", "/premios/me-mimei/20.webp",
        "/premios/me-mimei/50.webp", "/premios/me-mimei/100.webp", "/premios/me-mimei/200.webp",
        "/premios/me-mimei/500.webp", "/premios/me-mimei/1000.webp", "/premios/me-mimei/2000.webp",
        "/premios/me-mimei/5000.webp", "/premios/me-mimei/10000.webp", "/premios/me-mimei/100000.webp"
      ];
  ...
  const prizeData = [
    { value: 100000, path: "/premios/me-mimei/100000.webp", name: "Anel Vivara Diamante" },
    { value: 10000, path: "/premios/me-mimei/10000.webp", name: "Dyson Secador" },
    { value: 5000, path: "/premios/me-mimei/5000.webp", name: "Bolsa Luxo Michael Kors" },
    { value: 2000, path: "/premios/me-mimei/2000.webp", name: "Kit Kerastase" },
    { value: 1000, path: "/premios/me-mimei/1000.webp", name: "Kit Completo Bruna Tavares" },
    { value: 500, path: "/premios/me-mimei/500.webp", name: "Perfume Good Girl" },
    { value: 200, path: "/premios/me-mimei/200.webp", name: "Kit WEPINK" },
    { value: 100, path: "/premios/me-mimei/100.webp", name: "Bolsa Petite Jolie" },
    { value: 50, path: "/premios/me-mimei/50.webp", name: "Perfume Egeo Dolce" },
    { value: 20, path: "/premios/me-mimei/20.webp", name: "Iluminador Bruna Tavares" },
    { value: 15, path: "/premios/me-mimei/15.webp", name: "Máscara Ruby Rose" },
    { value: 10, path: "/premios/me-mimei/10.webp", name: "Batom Boca Rosa" },
    { value: 5, path: "/premios/me-mimei/5.webp", name: "5 reais" },
    { value: 4, path: "/premios/me-mimei/4.webp", name: "4 reais" },
    { value: 3, path: "/premios/me-mimei/3.webp", name: "3 reais" },
    { value: 2, path: "/premios/me-mimei/2.webp", name: "2 reais" },
    { value: 1, path: "/premios/me-mimei/1.webp", name: "1 real" },
    { value: 0.5, path: "/premios/me-mimei/0.5.webp", name: "50 centavos" }
  ];
  ...
  const [bonusChange, setBonusChange] = useState<{ amount: number; isBonus: boolean } | null>(null);


  
  // Check for free plays from URL params
  useEffect(() => {
    ...
    if (balanceData && user) {
      ...
      if (storedBalance && storedBonus) {
        ...
        if (newScratchBonus !== lastBonus) {
          ...
          setBonusChange({ amount: change, isBonus: true });
  ...
  const startGame = async (useScratchBonus: boolean = false) => {
    ...
    if (user && balanceData) {
      const gameCost = 1 * multiplier; // RASPADELAS game costs R$1 × multiplier
    ...
    try {
      ...
      await apiRequest("/api/games/clear-game-type/premio-me-mimei", "DELETE").catch(() => {});
      ...
      if (typeof window !== 'undefined' && (window as any).fbq) {
        (window as any).fbq('track', 'AddToCart', {
          content_name: 'Raspadinha RASPADELAS',
          content_category: 'raspadinha',
          content_type: 'game',
          value: 1 * multiplier,
          currency: 'BRL',
          content_ids: ['premio-me-mimei']
        });
      }
  ...
  const handleReveal = async (index: number) => {
    if (!gameStarted || revealed[index] || gameComplete || isCheckingResult || processingRef.current) return;
  ...
  const checkGameResult = async () => {
    ...
    try {
      const response = await apiRequest(
        `/api/games/premio-me-mimei/${currentGameId}/reveal`,
        "POST",
      );
      ...
      if (response.won && response.prize > 0) {
        ...
        if (multiplier === 1) {
          balanceTracker.addLocalBonusChange(response.prize);
        } else {
      ...
      if (currentGameId) {
        ...
        // Also clear any premio-me-mimei sessions to prevent "game in progress" bug
        apiRequest(`/api/games/clear-game-type/premio-me-mimei`, "DELETE").catch(() => {});
      }
  ...
  return (
    <MobileLayout showBonusMode={multiplier === 1}>
        ...
        <div className="flex-1 flex flex-col px-4 pt-6 pb-6 max-w-md md:max-w-3xl mx-auto w-full">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-2xl md:text-4xl font-bold text-pink-400">Raspa Delas</h1>
              <p className="text-gray-400 text-sm md:text-base mt-1">
                Raspou, achou 3 iguais, <span className="text-pink-400 font-bold">Ganhou!</span>
              </p>
              {freePlays > 0 && (
                <div className="mt-3 inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-gray-800/50 rounded-full border border-gray-700">
                  ...
                  <span className="text-pink-400 font-bold text-sm md:text-base">{freePlays} jogadas grátis</span>
                </div>
              )}
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                {gameComplete && resultReady && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Eye className={`w-5 h-5 ${hideOverlay ? "text-pink-400" : "text-white"}`} />
                  </motion.button>
                )}
                  ...
                  {gameComplete && resultReady && !hideOverlay && (
                    <>
                      ...
                      <motion.div
                        ...
                        style={{
                          background: won 
                            ? "linear-gradient(135deg, rgba(0,0,0,0.95) 0%, rgba(236,72,153,0.15) 50%, rgba(0,0,0,0.95) 100%)"
                      ...
                      {won && (
                        ...
                        >
                          <div className="absolute inset-0 bg-gradient-to-t from-pink-400/10 via-transparent to-transparent" />
                          <div 
                            className="absolute inset-0"
                            style={{
                              background: "conic-gradient(from 180deg at 50% 50%, transparent 0deg, rgba(236,72,153,0.05) 60deg, transparent 120deg, rgba(236,72,153,0.05) 180deg, transparent 240deg, rgba(236,72,153,0.05) 300deg, transparent 360deg)",
                          ...
                          {won ? (
                            <>
                              ...
                              <motion.div
                                ...
                                className="mb-6"
                              >
                                <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-200 via-pink-400 to-pink-200 tracking-wider">
                                  VOCÊ GANHOU!
                                </h2>
                              </motion.div>
                              ...
                              >
                                ...
                                <motion.div
                                  ...
                                  className="absolute inset-0 -m-8 bg-gradient-to-r from-pink-400/20 via-pink-300/20 to-pink-400/20 blur-3xl"
                                />
                                ...
                                <div className="relative">
                                  <motion.div
                                    ...
                                    style={{
                                      textShadow: "0 0 30px rgba(236,72,153,0.6), 0 0 60px rgba(236,72,153,0.3)"
                                    }}
                                  >
                                  ...
                                  <motion.div
                                    ...
                                    className="mb-4"
                                  >
                                    {getPrizeInfo(prizeValue || prize.toString()).path ? (
                                      <img
                                      ...
                                      <div className="text-5xl">
                                        {getPrizeInfo(prizeValue || prize.toString()).icon}
                                      </div>
                                    )}
                                  </motion.div>
                              ...
                              {multiplier > 1 && (
                                <motion.div
                                  ...
                                  className="mb-4"
                                >
                                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-full backdrop-blur-sm">
                      ...
                      <div className="relative w-full h-full flex flex-col items-center justify-center p-6">
                        ...
                        {!gameStarted && (
                          ...
                          >
                            ...
                            <div className="relative overflow-hidden rounded-[30px] p-1 bg-gradient-to-br from-pink-500/20 via-transparent to-pink-500/20">
                              <div className="relative bg-black/80 backdrop-blur-2xl rounded-[26px] p-4 sm:p-8 border border-white/5">
                                {/* Animated Background Pattern */}
                                <div className="absolute inset-0 opacity-10">
                                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(236,72,153,0.2)_0%,transparent_50%)]" />
                                        ...
                                        `}>
                                          ...
                                          <div className="relative z-10">
                                            ...
                                            <div className={`
                                              ...
                                              ${multiplier === value ? 'text-pink-200' : 'text-gray-500'}
                                            `}>
                                              R$ {value},00
                                            </div>
                                          </div>
                                          ...
                                          {multiplier === value && (
                                            <motion.div
                                              ...
                                              className="absolute top-1 right-1 w-6 h-6 bg-gradient-to-br from-pink-400 to-pink-600 rounded-full flex items-center justify-center shadow-lg shadow-pink-500/50 z-20"
                                            >
                                ...
                                <div className="mt-4 flex gap-2 w-full">
                                  ...
                                  <motion.button
                                    ...
                                    className="flex-[2] bg-gradient-to-r from-pink-500 to-pink-400 hover:from-pink-400 hover:to-pink-300 text-white px-4 py-3 md:px-6 md:py-4 rounded-xl font-bold transition-all hover:shadow-xl text-sm md:text-base relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
                                  >
                    ...
                    (value, index) => (
                      <div 
                        ...
                        {winningIndices.includes(index) && hideOverlay && (
                          ...
                          >
                            <div className="absolute inset-0 rounded-2xl border-4 border-pink-400 shadow-[0_0_20px_rgba(236,72,153,0.5)]" />
                            <div className="absolute -inset-1 rounded-2xl border-2 border-pink-400/30 animate-pulse" />
                          </motion.div>
                        )}
                              ...
                              {gameStarted ? (
                                value === "" ? (
                                  ...
                                  >
                                    ...
                                    {getPrizeInfo(value).path && getPrizeInfo(value).path !== null ? (
                                      <img
                                      ...
                                      <div className="w-10 h-10 md:w-16 md:h-16 flex items-center justify-center mb-1">
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 rounded-xl flex flex-col items-center justify-center p-2">
                                  ...
                                  <img
                                    src={getPrizeInfo(productPrizes[index % productPrizes.length].value).path || ""}
                                    alt={getPrizeInfo(productPrizes[index % productPrizes.length].value).name}
                                  ...
                                  <div className="h-6 flex items-center justify-center px-1 w-full">
                                    <p className="text-gray-300 text-[9px] font-bold text-center leading-[11px] uppercase opacity-50 line-clamp-2">
                                      {getPrizeInfo(productPrizes[index % productPrizes.length].value).name}
                                    </p>
                                  </div>
                                </div>
                              )}
              ...
              {gameComplete && resultReady && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 -mt-[1px] rounded-b-3xl transition-all hover:shadow-lg overflow-hidden border-l border-r border-b border-gray-700/30"
                >
                  <button
          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-pink-600/20 via-purple-600/20 to-pink-600/20 blur-3xl -z-10"></div>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <ChevronLeft className="w-8 h-8 text-pink-400" />
                              </motion.div>
                              <motion.div 
                                className="flex items-center"
                                animate={{ opacity: [0.3, 1, 0.3] }}
                              ...
                              >
                                <ChevronLeft className="w-8 h-8 text-pink-400/80 -ml-4" />
                              </motion.div>
                              <motion.div 
                                className="flex items-center"
                                animate={{ opacity: [0.3, 1, 0.3] }}
                              ...
                              >
                                <ChevronLeft className="w-8 h-8 text-pink-400/60 -ml-4" />
                              </motion.div>
                            </motion.div>
                          </motion.div>
                        </motion.div>
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-900/70 to-black/90 backdrop-blur-xl rounded-3xl overflow-hidden border border-gray-700/50 shadow-2xl">
                          ...
                          <div className="relative p-3 flex flex-col items-center">
                            ...
                            <div className="relative">
                              <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-pink-600 blur-lg opacity-50"></div>
                              <div className="relative font-black text-sm whitespace-nowrap bg-gradient-to-r from-pink-300 to-pink-500 bg-clip-text text-transparent">
                ...
                <div className="relative mt-6 h-12">
                  ...
                  <AnimatePresence>
                    {scrollProgress > 5 && (
                      ...
                      >
                        <motion.button
                          className="flex items-center gap-1 text-pink-400/60 hover:text-pink-400 cursor-pointer bg-gray-900/80 md:bg-gray-800/90 backdrop-blur-sm rounded-full p-2 md:p-3 border border-gray-700/50 hover:border-pink-400/50 transition-all"
                          animate={{ x: [0, -5, 0] }}
            ...
            <div className="bg-gray-900/50 rounded-2xl p-4 backdrop-blur-sm">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-300">Escolha o <span className="text-pink-400 font-semibold">multiplicador</span> (1x, 5x ou 10x) para aumentar seus ganhos</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-300">O valor do prêmio é <span className="text-pink-400 font-semibold">multiplicado</span> e convertido em saldo real</p>
                </div>
              </div>
            </div>

            {/* Game Feed */}
            <GameFeed gameName="Me Mimei" gameColor="pink" />
          </div>
        </div>
      </div>
      ...
      <MultiplierInfoModal
        ...
        gameType="me-mimei"
        gameCost={1}
        themeColor="from-pink-500 to-pink-600"
      />
          ...
          >
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-pink-400 mb-2">Como Jogar</h3>
                <p className="text-gray-400 text-sm">Me Mimei</p>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-pink-400 font-semibold mb-1">Dica de Ouro</p>
                    <p className="text-xs text-gray-400">
                      Produtos de beleza exclusivos estão esperando por você! Quanto maior o multiplicador, melhores os prêmios!
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.button
                ...
                transition={{ delay: 0.6 }}
                onClick={() => setShowInfoModal(false)}
                className="mt-6 w-full py-3 bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white font-bold rounded-xl transition-all transform hover:scale-105"
              >
                Entendi, vamos jogar!
              </motion.button>
            </motion.div>
