          ...
          <div className="relative mb-6">
            ...
            >
              ...
              >
                ...
                {/* Premium Beauty Themed Result Overlay */}
                <AnimatePresence>
                    ...
                    >
                      ...
                      {won && (
                        <>
                          ...
                          >
                            <div className="absolute inset-0 bg-gradient-conic from-pink-500/20 via-transparent to-pink-500/20" />
                          </motion.div>
                          
                          {/* Floating hearts and beauty items */}
                          {[...Array(8)].map((_, i) => (
                            <motion.div
                              key={i}
                      ...
                      >
                        ...
                        {won && (
                          <motion.div
                            ...
                            className="absolute -inset-8 bg-gradient-to-r from-pink-500/30 via-purple-500/30 to-pink-500/30 blur-3xl rounded-full pointer-events-none"
                          />
                        )}
                        ...
                        <div className="relative z-10">
                            ...
                            {won ? (
                              <div className="relative">
                                ...
                                <motion.div
                                  ...
                                  className="absolute -inset-4 bg-gradient-to-r from-pink-400 to-purple-400 rounded-2xl blur-xl"
                                />
                                
                                {/* Prize image container */}
                                <div className="relative w-28 h-28 mx-auto rounded-2xl overflow-hidden shadow-2xl border-2 border-pink-400/50">
                                  <img 
                          ...
                          >
                            {won ? (
                              <>
                                <h3 className="text-2xl font-black mb-2 bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-pulse">
                                  VOCÊ GANHOU!
                                </h3>
                                <motion.div
                                  initial={{ scale: 0 }}
                          ...
                          >
                            {won ? (
                              ...
                              <span className="text-gray-400">
                                A beleza da vitória está chegando!
                              </span>
                            )}
                          </motion.p>
