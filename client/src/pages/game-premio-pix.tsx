          ...
          <div className="relative mb-6">
            ...
            >
              ...
              >
                ...
                {/* Premium Internal Result Overlay */}
                <AnimatePresence>
                    ...
                    >
                      ...
                      {won && (
                        <>
                          ...
                          >
                            <div className="absolute inset-0 bg-gradient-conic from-green-500/20 via-transparent to-green-500/20" />
                          </motion.div>
                      ...
                      >
                        ...
                        {won && (
                          <motion.div
                            ...
                            className="absolute -inset-8 bg-gradient-to-r from-green-500/30 via-emerald-500/30 to-green-500/30 blur-3xl rounded-full pointer-events-none"
                          />
                        )}
                        ...
                        <div className="relative z-10">
                              ...
                              <div className="relative">
                                ...
                                <div className="relative w-28 h-28 mx-auto rounded-2xl overflow-hidden shadow-2xl border-2 border-green-400/50">
                                  <img 
                                    ...
                                    alt="Prêmio"
                                    className="w-full h-full object-contain bg-gradient-to-br from-green-900/50 to-emerald-900/50 p-2"
                                  />
                          ...
                          >
                            {won ? (
                              <>
                                <h3 className="text-2xl font-black mb-2 bg-gradient-to-r from-green-400 via-emerald-400 to-green-400 bg-clip-text text-transparent animate-pulse">
                                  VOCÊ GANHOU!
                                </h3>
                                <motion.div
                                  initial={{ scale: 0 }}
                          ...
                          >
                            {won ? (
                              ...
                              <span className="text-gray-400">
                                A sorte está chegando, não desista!
                              </span>
                            )}
                          </motion.p>
