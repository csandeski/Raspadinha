...
import { ArrowLeft, Trophy, Sparkles, Star, Eye, Info, Gift, ShoppingCart, X, ChevronLeft, ChevronRight } from "lucide-react";
...
const getRarityBadge = (value: string): string | null => {
  ...
  if (num >= 10000) return "MÍTICA";
  if (num >= 100) return "RARA";
  return null;
};

// Prize value to product info mapping
const getPrizeInfo = (value: string, _mode?: number): { icon: string; name: string; path: string | null; image?: string } => {
  const prizeValue = parseFloat(value);
  if (!isNaN(prizeValue)) {
    switch (prizeValue) {
      case 10: return { icon: "💸", name: "10 reais", path: `/premios/super-premios/10.webp`, image: `/premios/super-premios/10.webp` };
      case 20: return { icon: "💸", name: "20 reais", path: `/premios/super-premios/20.webp`, image: `/premios/super-premios/20.webp` };
      case 40: return { icon: "💸", name: "40 reais", path: `/premios/super-premios/40.webp`, image: `/premios/super-premios/40.webp` };
      case 60: return { icon: "💸", name: "60 reais", path: `/premios/super-premios/60.webp`, image: `/premios/super-premios/60.webp` };
      case 80: return { icon: "💸", name: "80 reais", path: `/premios/super-premios/80.webp`, image: `/premios/super-premios/80.webp` };
      case 100: return { icon: "💸", name: "100 reais", path: `/premios/super-premios/100.webp`, image: `/premios/super-premios/100.webp` };
      case 200: return { icon: "🕶️", name: "Óculos", path: `/premios/super-premios/200.webp`, image: `/premios/super-premios/200.webp` };
      case 300: return { icon: "🪖", name: "Capacete", path: `/premios/super-premios/300.webp`, image: `/premios/super-premios/300.webp` };
      case 400: return { icon: "🚲", name: "Bicicleta", path: `/premios/super-premios/400.webp`, image: `/premios/super-premios/400.webp` };
      case 1000: return { icon: "🛴", name: "HoverBoard", path: `/premios/super-premios/1000.webp`, image: `/premios/super-premios/1000.webp` };
      case 2000: return { icon: "🛴", name: "Patinete Elétrico", path: `/premios/super-premios/2000.webp`, image: `/premios/super-premios/2000.webp` };
      case 4000: return { icon: "🛵", name: "Scooter Elétrica", path: `/premios/super-premios/4000.webp`, image: `/premios/super-premios/4000.webp` };
      case 10000: return { icon: "🚗", name: "Buggy", path: `/premios/super-premios/10000.webp`, image: `/premios/super-premios/10000.webp` };
      case 20000: return { icon: "🏍️", name: "Moto CG", path: `/premios/super-premios/20000.webp`, image: `/premios/super-premios/20000.webp` };
      case 200000: return { icon: "🚙", name: "Jeep Compass", path: `/premios/super-premios/200000.webp`, image: `/premios/super-premios/200000.webp` };
      case 500000: return { icon: "🌟", name: "Super Sorte", path: `/premios/super-premios/500000.webp`, image: `/premios/super-premios/500000.webp` };
      default: return { icon: "🎁", name: "", path: `/premios/super-premios/10.webp`, image: `/premios/super-premios/10.webp` };
    }
  }
  
  return { icon: "🎁", name: value, path: `/premios/super-premios/10.webp`, image: `/premios/super-premios/10.webp` };
};
...
export default function GamePremioSuperPremios() {
  ...
  useEffect(() => {
    const preloadImages = () => {
      const imagePaths = [
        "/premios/super-premios/0.5.webp", "/premios/super-premios/1.webp", "/premios/super-premios/2.webp",
        "/premios/super-premios/3.webp", "/premios/super-premios/4.webp", "/premios/super-premios/5.webp",
        "/premios/super-premios/10.webp", "/premios/super-premios/15.webp", "/premios/super-premios/20.webp",
        "/premios/super-premios/50.webp", "/premios/super-premios/100.webp", "/premios/super-premios/200.webp",
        "/premios/super-premios/500.webp", "/premios/super-premios/1000.webp", "/premios/super-premios/2000.webp",
        "/premios/super-premios/5000.webp", "/premios/super-premios/10000.webp", "/premios/super-premios/100000.webp"
      ];
  ...
  const prizeData = [
    { value: 500000, path: "/premios/super-premios/500000.webp", name: "Super Sorte" },
    { value: 200000, path: "/premios/super-premios/200000.webp", name: "Jeep Compass" },
    { value: 20000, path: "/premios/super-premios/20000.webp", name: "Moto CG" },
    { value: 10000, path: "/premios/super-premios/10000.webp", name: "Buggy" },
    { value: 4000, path: "/premios/super-premios/4000.webp", name: "Scooter Elétrica" },
    { value: 2000, path: "/premios/super-premios/2000.webp", name: "Patinete Elétrico" },
    { value: 1000, path: "/premios/super-premios/1000.webp", name: "HoverBoard" },
    { value: 400, path: "/premios/super-premios/400.webp", name: "Bicicleta" },
    { value: 300, path: "/premios/super-premios/300.webp", name: "Capacete" },
    { value: 200, path: "/premios/super-premios/200.webp", name: "Óculos" },
    { value: 100, path: "/premios/super-premios/100.webp", name: "100 reais" },
    { value: 80, path: "/premios/super-premios/80.webp", name: "80 reais" },
    { value: 60, path: "/premios/super-premios/60.webp", name: "60 reais" },
    { value: 40, path: "/premios/super-premios/40.webp", name: "40 reais" },
    { value: 20, path: "/premios/super-premios/20.webp", name: "20 reais" },
    { value: 10, path: "/premios/super-premios/10.webp", name: "10 reais" }
  ];
  ...
  const { data: balanceData, refetch: balanceRefetch } = useQuery<{ balance: string; scratchBonus: number }>({
  ...
  }, [gameStarted, gameId, values, revealed, hasStartedScratching, allCardsRevealed, restoringState, gameComplete]);
  ...
  const startGame = async (useScratchBonus: boolean = false) => {
    ...
    if (user && balanceData) {
      const gameCost = 20 * multiplier; // Super Prêmios game costs R$20 × multiplier
    ...
    try {
      ...
      await apiRequest("/api/games/clear-game-type/premio-super-premios", "DELETE").catch(() => {});
      ...
      if (typeof window !== 'undefined' && (window as any).fbq) {
        (window as any).fbq('track', 'AddToCart', {
          content_name: 'Raspadinha Super Prêmios',
          content_category: 'raspadinha',
          content_type: 'game',
          value: 20 * multiplier,
          currency: 'BRL',
          content_ids: ['premio-super-premios']
        });
      }
  ...
  const checkGameResult = async () => {
    ...
    try {
      const response = await apiRequest(
        `/api/games/premio-super-premios/${currentGameId}/reveal`,
        "POST",
      );
      ...
      if (currentGameId) {
        ...
        // Also clear any premio-super-premios sessions to prevent "game in progress" bug
        apiRequest(`/api/games/clear-game-type/premio-super-premios`, "DELETE").catch(() => {});
      }
  ...
  const formatPrize = (value: string) => {
    ...
    if (num >= 10000) return `R$${num / 1000}k`;
    return `R$${num}`;
  };
  ...
  return (
    <MobileLayout showBonusMode={multiplier === 1}>
        ...
        <div className="flex-1 flex flex-col px-4 pt-6 pb-6 max-w-md md:max-w-3xl mx-auto w-full">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-2xl md:text-4xl font-bold text-green-400">Super Prêmios</h1>
              <p className="text-gray-400 text-sm md:text-base mt-1">
                Raspou, achou 3 iguais, <span className="text-green-400 font-bold">Ganhou!</span>
              </p>
              {freePlays > 0 && (
                <div className="mt-3 inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-gray-800/50 rounded-full border border-gray-700">
                  ...
                  <span className="text-green-400 font-bold text-sm md:text-base">{freePlays} jogadas grátis</span>
                </div>
              )}
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                {gameComplete && resultReady && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Eye className={`w-5 h-5 ${hideOverlay ? "text-green-400" : "text-white"}`} />
                  </motion.button>
                )}
                  ...
                  {gameComplete && resultReady && !hideOverlay && (
                    <>
                      ...
                      <motion.div
                        ...
                        style={{
                          background: won 
                            ? "linear-gradient(135deg, rgba(0,0,0,0.95) 0%, rgba(34,197,94,0.15) 50%, rgba(0,0,0,0.95) 100%)"
                      ...
                      {won && (
                        ...
                        >
                          <div className="absolute inset-0 bg-gradient-to-t from-green-400/10 via-transparent to-transparent" />
                          <div 
                            className="absolute inset-0"
                            style={{
                              background: "conic-gradient(from 180deg at 50% 50%, transparent 0deg, rgba(34,197,94,0.05) 60deg, transparent 120deg, rgba(34,197,94,0.05) 180deg, transparent 240deg, rgba(34,197,94,0.05) 300deg, transparent 360deg)",
                          ...
                          {won ? (
                            <>
                              ...
                              <motion.div
                                ...
                                className="mb-6"
                              >
                                <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-200 via-green-400 to-green-200 tracking-wider">
                                  VOCÊ GANHOU!
                                </h2>
                              </motion.div>
                              ...
                              >
                                ...
                                <motion.div
                                  ...
                                  className="absolute inset-0 -m-8 bg-gradient-to-r from-green-400/20 via-green-300/20 to-green-400/20 blur-3xl"
                                />
                              ...
                              {multiplier > 1 && (
                                <motion.div
                                  ...
                                  className="mb-4"
                                >
                                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-green-500/20 border border-purple-400/30 rounded-full backdrop-blur-sm">
                      ...
                      <div className="relative w-full h-full flex flex-col items-center justify-center p-6">
                        ...
                        {!gameStarted && (
                          ...
                          >
                            ...
                            <div className="relative overflow-hidden rounded-[30px] p-1 bg-gradient-to-br from-green-500/20 via-transparent to-green-500/20">
                              <div className="relative bg-black/80 backdrop-blur-2xl rounded-[26px] p-4 sm:p-8 border border-white/5">
                                {/* Animated Background Pattern */}
                                <div className="absolute inset-0 opacity-10">
                                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(34,197,94,0.2)_0%,transparent_50%)]" />
                                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_50%,rgba(34,197,94,0.2)_0%,transparent_50%)]" />
                                </div>
                                  ...
                                  >
                                    <span className="flex items-center justify-center gap-2 whitespace-nowrap">
                                      ...
                                      {!isLoading && !gameStarted && !gameComplete && (
                                        <span className="bg-black/30 px-2 py-0.5 md:px-3 md:py-1 rounded text-white font-bold text-sm md:text-base">R${20 * multiplier},00</span>
                                      )}
                                    </span>
                                  </motion.button>
                                  ...
                                  {!gameStarted && !gameComplete && (
                                    ...
                                    >
                                      <span className="flex items-center justify-center gap-1 whitespace-nowrap">
                                        ...
                                        <span className="bg-black/30 px-1.5 py-0.5 md:px-3 md:py-1 rounded text-white font-bold text-xs md:text-base">{20 * multiplier}</span>
                                      </span>
                                    </motion.button>
                                  )}
                                </div>
                ...
                <div 
                  ...
                  className="grid grid-cols-3 gap-2 md:gap-3 relative z-5"
                    ...
                    (value, index) => (
                      <div 
                        ...
                        {winningIndices.includes(index) && hideOverlay && (
                          ...
                          >
                            <div className="absolute inset-0 rounded-2xl border-4 border-green-400 shadow-[0_0_20px_rgba(34,197,94,0.5)]" />
                            <div className="absolute -inset-1 rounded-2xl border-2 border-green-400/30 animate-pulse" />
                          </motion.div>
                        )}
                            ...
                            <div className="w-full h-full relative overflow-hidden rounded-xl">
                              {gameStarted ? (
                                value ? (
                                  value === "" ? (
                                    ...
                                    >
                                      <img
                                        ...
                                        alt="Logo"
                                        className="max-w-[40px] max-h-[40px] w-auto h-auto object-contain mx-auto"
                                        draggable={false}
                                      />
                                    </motion.div>)
                                  ) : (
                                  ...
                                  /* Empty square - show company logo */
                                  (<motion.div
                                    initial={{ scale: 0.8, opacity: 0 }}
                                    animate={{ scale: 1, opacity: 1 }}
                                    transition={{ duration: 0.3 }}
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 rounded-xl flex flex-col items-center justify-center p-2">
                                  ...
                                  <img
                                    ...
                                    className="w-10 h-10 md:w-16 md:h-16 object-contain mb-1 opacity-50"
                                    draggable={false}
                                  />
                                  <div className="h-6 md:h-10 flex items-center justify-center px-1 w-full">
                                    <p className="text-gray-300 text-[9px] md:text-sm font-bold text-center leading-[11px] md:leading-tight uppercase opacity-50 line-clamp-2">
              ...
              {gameComplete && resultReady && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 -mt-[1px] rounded-b-3xl transition-all hover:shadow-lg overflow-hidden border-l border-r border-b border-gray-700/30"
                >
                  <button
          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-green-600/20 via-emerald-600/20 to-green-600/20 blur-3xl -z-10"></div>
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-900/70 to-black/90 backdrop-blur-xl rounded-3xl overflow-hidden border border-gray-700/50 shadow-2xl">
                          ...
                          <div className="relative p-3 flex flex-col items-center">
                            ...
                            {/* Value with clean green text */}
                            <div className="relative">
                              <div className="relative font-black text-sm whitespace-nowrap text-[#00E880]">
            ...
            {/* Game Feed */}
            <GameFeed gameName="Super Prêmios" gameColor="green" />
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-green-400 mb-2">Como Jogar</h3>
                <p className="text-gray-400 text-sm">Super Prêmios</p>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-green-400 font-semibold mb-1">Dica de Ouro</p>
                    <p className="text-xs text-gray-400">
                      Prêmios maiores, como carros e motos! Vale a pena arriscar com multiplicadores altos!
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.button
                ...
                transition={{ delay: 0.6 }}
                onClick={() => setShowInfoModal(false)}
                className="mt-6 w-full py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-xl transition-all transform hover:scale-105"
              >
                Entendi, vamos jogar!
              </motion.button>
            </motion.div>
      ...
      <InsufficientFundsModal
        ...
        requiredAmount={insufficientFundsType === "balance" ? 20 * multiplier : 20 * multiplier}
