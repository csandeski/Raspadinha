                  ...
                  {gameComplete && resultReady && (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {won ? (
                            <div className="w-20 h-20 mx-auto bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center shadow-xl">
                        ...
                        >
                          {won ? (
                            <>
                              <h2 className="text-3xl font-bold text-yellow-400 mb-2">Você ganhou!</h2>
                        ...
                        <motion.button
                          ...
                          className="mt-6 px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white rounded-xl font-bold transition-all shadow-lg"
                        >
                          Jogar Novamente
                        </motion.button>
                      </motion.div>
