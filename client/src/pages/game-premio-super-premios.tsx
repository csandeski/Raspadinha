          ...
          <div className="relative mb-6">
            ...
            >
              ...
              >
                ...
                {/* Premium Golden Trophy Result Overlay */}
                <AnimatePresence>
                    ...
                    >
                      ...
                      {won && (
                        <>
                          ...
                          >
                            <div className="absolute inset-0 bg-gradient-conic from-yellow-500/20 via-transparent to-yellow-500/20" />
                          </motion.div>
                          
                          {/* Floating gold coins and trophies */}
                          {[...Array(8)].map((_, i) => (
                            <motion.div
                              key={i}
                      ...
                      >
                        ...
                        {won && (
                          <motion.div
                            ...
                            className="absolute -inset-8 bg-gradient-to-r from-yellow-500/30 via-amber-500/30 to-yellow-500/30 blur-3xl rounded-full pointer-events-none"
                          />
                        )}
                        ...
                        <div className="relative z-10">
                            ...
                            {won ? (
                              <div className="relative">
                                ...
                                <motion.div
                                  ...
                                  className="absolute -inset-4 bg-gradient-to-r from-yellow-400 to-amber-400 rounded-2xl blur-xl"
                                />
                                
                                {/* Prize image container */}
                                <div className="relative w-28 h-28 mx-auto rounded-2xl overflow-hidden shadow-2xl border-2 border-yellow-400/50">
                          ...
                          >
                            {won ? (
                              <>
                                <h3 className="text-2xl font-black mb-2 bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-400 bg-clip-text text-transparent animate-pulse">
                                  SUPER PRÊMIO!
                                </h3>
                                <motion.div
                                  initial={{ scale: 0 }}
