...
export function PainelAfiliadoDashboard() {
  ...
  const { data: earningsData, isLoading: earningsLoading, error: earningsError } = useAffiliateEarnings();
  const { data: dashboardStats, isLoading: statsLoading, error: statsError } = useAffiliateDashboardStats();
  const { data: performanceData, isLoading: perfLoading, error: perfError } = useAffiliatePerformance();
  ...
  const { data: depositStats } = useQuery({
    queryKey: ['/api/affiliate/deposits-stats'],
  ...
  // Use memoized level calculations with safe defaults
  const approvedEarnings = (affiliateInfo as any)?.approvedEarnings || 0;
  const { currentLevel, nextLevel, progressToNext } = useAffiliateLevelInfo(approvedEarnings);
  const currentLevelRate = (affiliateInfo as any)?.currentLevelRate || 40;

  // Memoize calculations to avoid re-computing with safe defaults
  const metrics = useMemo(() => ({
    totalClicks: (affiliateInfo as any)?.totalClicks || 0,
    totalRegistrations: (affiliateInfo as any)?.totalRegistrations || 0,
    totalDeposits: (affiliateInfo as any)?.totalDeposits || 0,
    totalEarnings: parseFloat((affiliateInfo as any)?.totalEarnings || '0'),
    pendingEarnings: parseFloat((affiliateInfo as any)?.pendingEarnings || '0'),
    availableBalance: parseFloat((earningsData as any)?.wallet?.balance || '0'),
    totalWithdrawn: parseFloat((earningsData as any)?.wallet?.totalWithdrawn || '0')
  }), [affiliateInfo, earningsData]);
  ...
  }, [affiliateInfo, metrics, previousData]);
  ...
  return (
    <AffiliateLayout activeSection="dashboard">
      <div className="space-y-3 md:space-y-6">
            ...
            <div className="relative bg-gradient-to-br from-gray-900/95 to-gray-950/95 backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-800 hover:border-[#00E880]/30 transition-all">
              ...
              <div className="space-y-1">
                ...
                {earningsLoading ? (
                  ...
                  <div>
                    <p className="text-lg md:text-2xl font-bold text-gray-500">—</p>
            ...
            <div className="bg-gradient-to-br from-gray-900/95 to-gray-950/95 backdrop-blur-xl rounded-xl p-4 border border-gray-800">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2">
                  <span className="text-xs text-gray-500">Comissão Atual</span>
                  <span className="text-sm font-bold text-[#00E880]">{currentLevelRate}%</span>
                </div>
              </div>
            </div>
        ...
        >
          {/* Tutorial Header */}
          <h2 className="text-xl font-bold text-white">Aprenda a usar o painel</h2>
          <p className="text-sm text-gray-400 mt-1 mb-4">Siga estes passos simples para ter sucesso como afiliado</p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-900/95 to-gray-950/95 backdrop-blur-xl rounded-xl md:rounded-2xl p-3 md:p-6 border border-gray-800">
              ...
              {/* Step 1 */}
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-[#00E880]/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Crie Seus Links</h3>
                </div>
              ...
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-purple-500/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Compartilhe</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3">
              ...
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-amber-500/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Acompanhe sua Rede</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3">
                  Em "Rede" você vê todos que se cadastraram. Veja quando fazem depósitos e sua comissão.
                </p>
                <p className="text-xs text-amber-400 flex items-center gap-1">
                  <Sparkles className="w-3 h-3" />
                  Depositos em 24h valem mais
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-cyan-500/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Ganhe Comissões</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3">
              ...
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-emerald-500/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Solicite Saques</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3">
              ...
              <div className="p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50 hover:border-pink-500/30 transition-all">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-white">Use Materiais</h3>
                </div>
                <p className="text-sm text-gray-400 mb-3">
            ...
            {/* Support Info */}
            <div className="mt-6 p-4 bg-gray-800/30 rounded-lg md:rounded-xl border border-gray-700/50">
              <p className="text-sm text-gray-300 flex items-center justify-center gap-2">
                <MessageSquare className="w-4 h-4 text-[#00E880]" />
                Dúvidas? Use o{' '}
                <span 
                  className="text-[#00E880] font-semibold cursor-pointer hover:text-[#00E880]/80 transition-colors"
                  onClick={() => setLocation("/afiliados/support")}
                >
                  Suporte
                </span>
              </p>
