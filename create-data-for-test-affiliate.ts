...
async function createDataForTestAffiliate() {
  try {
    ...
    console.log('Dados antigos removidos para afiliado teste2');
    ...
    console.log('Criando dados de teste para afiliado teste2@afiliado.com...\n');
    ...
    for (const data of testData) {
      ...
      for (let i = 0; i < data.pending; i++) {
        const depositAmount = data.amounts[amountIndex++];
        const commission = depositAmount * 0.50;
    ...
    console.log('\n✅ DADOS CRIADOS COM SUCESSO PARA TESTE2!');
