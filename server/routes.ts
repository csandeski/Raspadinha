  ...
  app.post("/api/admin/prize-probabilities/initialize", authenticateAdmin, async (req, res) => {
    try {
      ...
      const realGamePrizes = {
        'premio-pix': [
          { value: '0.50', name: '50 centavos', probability: 43.0 },
          { value: '1.00', name: '1 real', probability: 6.6 },
          { value: '2.00', name: '2 reais', probability: 3.3 },
          { value: '3.00', name: '3 reais', probability: 2.2 },
          { value: '4.00', name: '4 reais', probability: 1.69 },
          { value: '5.00', name: '5 reais', probability: 1.3 },
          { value: '10.00', name: '10 reais', probability: 0.6 },
          { value: '15.00', name: '15 reais', probability: 0.4 },
          { value: '20.00', name: '20 reais', probability: 0.3 },
          { value: '50.00', name: '50 reais', probability: 0.1 }
        ],
        'premio-me-mimei': [
